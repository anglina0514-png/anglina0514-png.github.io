...
- First viewport now keeps the Alche-style hierarchy: giant glass N, faint NING depth word, small lower-left News, and right-side `scroll to explore ->`.
- Navigation maps to `News / Works / About / Products` with right utility `Resume / Contact`.
...
- News copy keeps two items and removes the temporary `NING particle hero上线` update.
...
- News, About, Products, and Footer use NING content without dashboard/contact-CTA blocks.
